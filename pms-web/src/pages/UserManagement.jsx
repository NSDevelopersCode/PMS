...
function UserManagement() {
    ...
    const getRoleBadge = (role) => {
        ...
        return styles[role] || (isDark ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700');
    };
            ...
            <header className="bg-white dark:bg-slate-800 shadow-sm border-b border-gray-200 dark:border-slate-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <Link to="/admin" className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">← Dashboard</Link>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 font-medium py-2 px-4 rounded-lg transition-colors"
                        >
                            Logout
                        </button>
                    </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400 mt-1">Manage developers and administrators</p>
                    </div>
                    <button
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                                    {users.map((u) => (
                                        <tr key={u.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${getStatusBadge(u.isActive)}`}>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-md w-full p-6">
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">EndUsers must register via public signup</p>
                            </div>
                        </div>
